...
$asunto='Estado de cuenta Grupo Alze';
$mensaje='Estimado proveedor le recordamos actualizar su estado de cuenta, desde el portal de proveedores Grupo Alze, en el apartado ver mi documentación. <br>
...
$consulta="SELECT email_repre, repres_ventas FROM altaproveedor WHERE (DATEDIFF(now(),fecha_nue)) >=30 AND contrasena<>''";
