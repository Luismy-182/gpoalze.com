...
/*esto es un espejo de compras.php lo único que cambia es que se agrega el apartado opinión de cumplimiento y la 
...
if ($tipo=='ESTANDAR') {
    header("location:prospectosus.php");
}
//si es usuario con privilegio estándar, lo redirigirá a prospectosus.php donde es exactamente lo mismo, solo que capado de algunas funciones administrativas*/
?>
...
?>
    ...
    echo "</td>";?>
                ...
                <!-- los href que contienen la ubicación de los archivos y su nombre-->

                <?php echo "<td>";
    echo "<a href='credenciales.php?rfc=".$mostrar['rfc'] ."'><img title='Convertir a proveedor oficial' src='/compras/img/agregar-usuario.png' width='20px'  alt='Hacer proveedor oficial' </a>";
